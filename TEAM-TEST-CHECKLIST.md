# LotKeys V0.9.4.101 team-test checklist

## Clean V0.9.4.83 baseline

- Open `https://mrmilo34.github.io/Lot-Keys-TEST/?build=094101` and confirm **V0.9.4.101 / 094101**.
...
- If the stable TEST signing secrets are configured, download **LotKeys-Android-V0.9.4.101** and install its `app-debug.apk` on an Android 11+ test phone. Otherwise confirm CI completes Android assemble/lint and intentionally withholds the unsigned APK.
...
- With a V0.9.4.92 reminder present, open V0.9.4.101 online and confirm it appears once, keeps its title/note/date/time/link/completion state, and no longer participates in appointment collisions after safe sync.
