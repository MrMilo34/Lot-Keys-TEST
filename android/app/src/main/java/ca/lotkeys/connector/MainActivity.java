...
public final class MainActivity extends Activity {
    ...
    private static final String TEST_URL = "https://mrmilo34.github.io/Lot-Keys-TEST/?build=095005";
    ...
    private void render() {
        ...
        text("Phone Connection · V0.9.5.05 TEST", 18, Color.rgb(100, 181, 246), true);
